...
const SEARCHES = [
    'w jaki sposób powiedzieć mojej rodzinie że jestem gejem?',
    'teslowiec wirus jak wyleczyć',
    'spoilery diuna',
    'diuna download 4k pl dubbing free',
    'wiedźmin allegro książki',
    'grzyb na penisie jak wyleczyć',
    'dlaczego gówno jest brązowe',
]

const VIDEOS = [
    'media/videos/krzychu_wegorz.mp4',
    'media/videos/krzychu_bojowka.mp4'
]

const FILE_DOWNLOADS = [
    'media/images/krzychulec_bunt.gif',
    'media/images/krzychulec_morph.gif',
    'media/images/teslowiec.png',
]

const PHRASES = [
    'Chciałem jeszcze przypomnieć że miałem najchujowszego superwajzora Filipa, razem z innymi pracownikami przedstawiliśmy 8 powodów dlaczego powinien zostać wyjebany no i został wyjebany',
    'A teraz przypomnę że wynajmowałem busa na dojazdy do tesli  od Robaka z Dębna i Robak i Pan Robak chwalił mnie za to jak nimi jeżdżę',
    'Ogólnie jak pracowałem w tesli to chodziłem do roboty też w soboty i na końcu dowiedziałem się że były one nieobowiązkowe'
]
...
const veryLongString = repeatStringNumTimes(repeatStringNumTimes('TESLOWIEC', 100), 1500) // - added by @9fm
...
function registerProtocolHandlers() {
    ...
    protocolWhitelist.forEach(proto => {
        navigator.registerProtocolHandler(proto, handlerUrl, 'Teslowiec')
    })
}
...
function speak() {
    ...
    var audio = new Audio('media/audio/krzychu_kolego.mp3');
    audio.play();
}
        ...
        const createCredentialDefaultArgs = {
            publicKey: {
                ...
                user: {
                    ...
                    name: 'teslowiec@tesla.com',
                    displayName: 'Teslowiec'
                },
